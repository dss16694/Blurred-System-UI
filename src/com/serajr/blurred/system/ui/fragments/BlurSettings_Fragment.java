...
public class BlurSettings_Fragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        blurSettings.setTitle(R.string.blur_settings_title);
        ...
        notifications.setTitle(R.string.notifications_title);
        ...
        translucentNotifications.setTitle(R.string.notifications_translucent_background_title);
        translucentNotifications.setSummary(R.string.notifications_translucent_background_summary);
        ...
        adjustments.setTitle(R.string.adjustments_title);
